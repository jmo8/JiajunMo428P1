...
public class WeatherAPI2 : MonoBehaviour
{
    public GameObject weatherTextObject;
    // add your personal API key after APPID= and before &units=
    string url = "http://api.openweathermap.org/data/2.5/weather?lat=37.7425&lon=-119.5375&appid=f94e7ccf1175315be3da0ce3afdec943&units=imperial";
    ...
    IEnumerator GetRequest(string uri)
    {
        using (UnityWebRequest webRequest = UnityWebRequest.Get(uri))
        {
            ...
            else
            {
                ...
                int easyTempC = (easyTempF - 32) * 5 / 9;
